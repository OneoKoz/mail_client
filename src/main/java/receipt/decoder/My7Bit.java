...
public class My7Bit implements Idecoder{
    ...
    public byte[] decode(String line) {
            ...
            for (int i = length; i >= 2; i -= 2) {
                String twos = line.substring((i - 2), i);//2 characters at a time on reverse direction
    ...
    private String fromHexTo8BitBinary(String hex){
        ...
        ret.append("0".repeat(Math.max(0, length)));//Append missing 0's
        ret.append(binary);
        return ret.toString();
    }
}
